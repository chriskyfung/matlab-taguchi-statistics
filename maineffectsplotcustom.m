function [figh,axesh] = taguchimaineffectsplot(y,group,fun,varargin)
...
defaults = {'','mean',[]};
[varnames,statistics,parent] =  internal.stats.parseArgs(args,defaults,varargin{:});
...
for i = 1:ng
    [maineffect, gname] = grpstats(y,group{i},{fun,'gname'});
